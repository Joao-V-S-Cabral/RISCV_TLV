...
m4+definitions(['
  ...
  //   o $illegal_instruction exception expression
  ...
  m4_define(['m4_instr_type_of_I2'], ['I'])
...
\TLV riscv_gen()
   ...
   \SV_plus
      ...
      m4_instr(I2, 32, I, 11100, 000, 0000000, 00000, ECALL)
      m4_instr(I2, 32, I, 11100, 000, 0000000, 00001, EBREAK)
